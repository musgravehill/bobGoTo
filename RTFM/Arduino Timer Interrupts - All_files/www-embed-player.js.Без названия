...
;function F(){this.Ka=this.Ka;this.S=this.S}
...
function $b(a,b){a.Ka?p(void 0)?b.call(void 0):b():(a.S||(a.S=[]),a.S.push(p(void 0)?x(b,void 0):b))}
F.prototype.w=function(){if(this.S)for(;this.S.length;)this.S.shift()()};
...
Xd(c,a,b.cf);if(d)a:if(204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||l;d?b.P&&b.P.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.Ub&&b.Ub.call(f,a,e)}},b.method,h,b.headers,b.responseType,b.withCredentials);
...
return a[$g]}
;function ah(){F.call(this);this.g=new Ig(this);this.va=this;this.aa=null}
z(ah,F);ah.prototype[Eg]=!0;g=ah.prototype;g.addEventListener=function(a,b,c,d){Qg(this,a,b,c,d)};
...
g.w=function(){ah.C.w.call(this);if(this.g){var a=this.g,b=0,c;for(c in a.b){for(var d=a.b[c],e=0;e<d.length;e++)++b,Hg(d[e]);delete a.b[c];a.f--}}this.aa=null};
...
mh.prototype.S=function(a){this.b=0;nh(this,2,a)};
mh.prototype.G=function(a){this.b=0;nh(this,3,a)};
function nh(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;var d;a:{var e=c,f=a.S,h=a.G;if(e instanceof mh)yh(e,qh(f||t,h||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(n){k=!1}else k=!1;if(k)e.then(f,h,a),d=!0;else{if(ga(e))try{var m=e.then;if(fa(m)){Ah(e,m,f,h,a);d=!0;break a}}catch(n){h.call(a,n);d=!0;break a}d=!1}}}d||(a.l=c,a.b=b,a.g=null,zh(a),3!=b||c instanceof uh||Bh(a,c))}}
...
Jh(this,a,b,function(a){if(!e)if(e=!0,d&&J(d),a)c.P&&c.P(a);else if(c.onError)c.onError()})};
...
function $i(a,b){if((!b||(5!=(Ri[b.errorCode]||5)?0:-1!=Ui.indexOf(b.errorCode)))&&Zi(a)){(b=aj(a))&&b.stopVideo&&b.stopVideo();var c=a.b;b&&b.getUpdatedConfigurationData&&(b=b.getUpdatedConfigurationData(),c=Zf(b));c.args.autoplay=1;c.args.html5_unavailable="1";Vi(a,c);Wi(a,"flash")}}
...
g.De=function(){if(!this.oa){var a=bj(this);a&&"html5"==cj(this)?(this.G="html5",this.A||this.Ra()):(dj(this),this.G="html5",a&&this.T?(this.j.appendChild(this.T),this.Ra()):(this.b.loaded=!0,this.U=x(function(){var a=this.j,c=this.b.clone();r("yt.player.Application.create")(a,c);this.Ra()},this),this.oa=!0,a?this.U():(xc(this.b.assets.js,this.U),og(this.b.assets.css))))}};
...
function dj(a){Fi("dcp");a.cancel();Ti(a);a.G=null;a.b&&(a.b.loaded=!1);var b=aj(a);"html5"==cj(a)?a.T=b:b&&b.destroy&&b.destroy();De(a.j);kh(a.ra);a.l=null;a.H=null}
g.cancel=function(){this.U&&Ec(this.b.assets.js,this.U);J(this.cc);this.oa=!1};
g.w=function(){dj(this);if(this.T&&this.b)try{this.T.destroy()}catch(b){ic(b)}this.Na=null;for(var a in this.i)l[this.i[a]]=null;this.Ya=this.b=this.f=null;delete this.j;delete this.o;Si.C.w.call(this)};var gj={},hj="player_uid_"+(1E9*Math.random()>>>0);function ij(a,b){a=w(a)?ye(a):a;b=Zf(b);var c=hj+"_"+ha(a),d=gj[c];if(d)return d.Zb(b),d.f;d=new Si(a,c);gj[c]=d;tc("player-added",d.f);$b(d,ma(jj,d));I(function(){d.Zb(b)},0);
return d.f}
...
;function Tj(){var a=Qe();return a?a:null}
;function Uj(a,b){(a=ye(a))&&a.style&&(a.style.display=b?"":"none",pe(a,"hid",!b))}
...
;var Xj={},Yj="ontouchstart"in document;function Zj(a,b,c){var d;switch(a){case "mouseover":case "mouseout":d=3;break;case "mouseenter":case "mouseleave":d=9}return Ne(c,function(a){return me(a,b)},!0,d)}
function ak(a){var b="mouseover"==a.type&&"mouseenter"in Xj||"mouseout"==a.type&&"mouseleave"in Xj,c=a.type in Xj||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=Xj[b],d;for(d in c.ha){var e=Zj(b,d,a.target);e&&!Ne(a.relatedTarget,function(a){return a==e},!0)&&c.B(d,e,b,a)}}if(b=Xj[a.type])for(d in b.ha)(e=Zj(a.type,d,a.target))&&b.B(d,e,a.type,a)}}
...
g.Ia=function(a){var b=parseInt(E(a,"tooltip-show-timer"),10);b&&(J(b),Jb(a,"tooltip-show-timer"));b=x(function(){if(a){var b=ye(jk(this,a));b&&(kk(b),b&&b.parentNode&&b.parentNode.removeChild(b),Jb(a,"content-id"));(b=ye(jk(this,a,"arialabel")))&&b.parentNode&&b.parentNode.removeChild(b)}Jb(a,"tooltip-hide-timer")},this);
...
function lk(a,b){fk(a,b);a=E(a,"content-id");(a=ye(a))&&Ge(a,b)}
function ik(a){return E(a,"tooltip-text")||a.title}
function hk(a,b){if(b){var c=ik(b);if(c){var d=ye(jk(a,b));if(!d){d=document.createElement("div");d.id=jk(a,b);d.className=S(a,"tip");var e=document.createElement("div");e.className=S(a,"tip-body");var f=document.createElement("div");f.className=S(a,"tip-arrow");var h=document.createElement("div");h.setAttribute("aria-hidden","true");h.className=S(a,"tip-content");var k=mk(a,b),m=jk(a,b,"content");h.id=m;Hb(b,"content-id",m);e.appendChild(h);k&&d.appendChild(k);d.appendChild(e);d.appendChild(f);var n=
Je(b),m=jk(a,b,"arialabel"),f=document.createElement("div");ne(f,S(a,"arialabel"));f.id=m;n=b.hasAttribute("aria-label")?b.getAttribute("aria-label"):"rtl"==document.body.getAttribute("dir")?c+" "+n:n+" "+c;Ge(f,n);b.setAttribute("aria-labelledby",m);m=Tj()||document.body;m.appendChild(f);m.appendChild(d);lk(b,c);(c=parseInt(E(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",ne(h,S(a,"normal-wrap")));h=me(b,S(a,"reverse"));nk(a,b,d,e,k,h)||nk(a,b,d,e,k,!h);var A=S(a,"tip-visible");
I(function(){ne(d,A)},0)}}}}
...
function jk(a,b,c){a=S(a);var d=b.__yt_uid_key;d||(d=Oe(),b.__yt_uid_key=d);b=a+d;c&&(b+="-"+c);return b}
function mk(a,b){var c=null;id&&me(b,S(a,"masked"))&&((c=ye("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),Vj(c)):(c=document.createElement("iframe"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",c.className=S(a,"tip-mask")));return c}
function kk(a){var b=ye("yt-uix-tooltip-shared-mask"),c=b&&Ne(b,function(b){return b==a},!1,2);
...
function rk(a){var b=E(a,pk.gd),c=!!E(a,"is-subscribed"),b="-"+b,d=Me.ad+b;pe(a,Me.$c+b,!c);pe(a,d,c);E(a,pk.ed)&&!E(a,pk.dd)&&(b=S(gk.getInstance()),pe(a,b,!c),a.title=c?"":E(a,pk.fd));c?I(function(){ne(a,Me.$b)},1E3):oe(a,Me.$b)}
g.qd=function(a){var b=!!E(a,"ypc-item-type"),c=!!E(a,"ypc-item-id");!E(a,"ypc-enabled")&&b&&c&&(ne(a,"ypc-enabled"),Hb(a,pk.jd,"true"))};
g.pd=function(a){E(a,"ypc-enabled")&&(oe(a,"ypc-enabled"),Jb(a,"ypc-enabled"))};
function sk(a,b){return Ia(ze(S(a)),function(a){return b==E(a,"channel-external-id")},a)}
...
function hl(a,b,c){function d(a,b){if(kb)return 0;uk.clearTimeout(A);$f.push.apply($f,Ja);var d=((Ck||{}).config||{}).update;d?d(f):f&&T(U,"cu",[]).push(f);if(b){Ik("me0",a,Zd);try{el(b,c,n)}finally{Ik("me1",a,Zd)}}return 1}
a=Ak(a)||[];var e=b.callback,f=b.config,h=b.timeout,k=b.ontimeout,m=b.onerror,n=void 0;"function"==typeof m&&(n=m);var A=null,kb=!1;if(h&&!k||!h&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var m=T(Fk(c),"r",[]).sort(),$f=T(Fk(c),"L",[]).sort(),Zd=[].concat(m);0<h&&(A=uk.setTimeout(function(){kb=!0;k()},h));
var Ja=al(a,$f);if(Ja.length){var Ja=al(a,m),rb=T(U,"CP",[]),sb=rb.length;rb[sb]=function(a){function b(){var a=rb[sb+1];a&&a()}
function c(b){rb[sb]=null;d(Ja,a)&&Ek(function(){e&&e();b()})}
if(!a)return 0;Ik("ml1",Ja,Zd);0<sb&&rb[sb-1]?rb[sb]=function(){c(b)}:c(b)};
if(Ja.length){var bh="loaded_"+U.I++;Ck[bh]=function(a){rb[sb](a);Ck[bh]=null};
a=Rk(c,Ja,"gapi."+bh,m);m.push.apply(m,Ja);Ik("ml0",Ja,Zd);b.sync||uk.___gapisync?bl(a):cl(a)}else rb[sb](xk)}else d(Ja)&&e&&e()}
...
var jl=null;function kl(a){return(new mh(function(b){try{var c={gapiHintOverride:a.gapiHintOverride,_c:{jsl:{h:a.gapiHintParams}},callback:b},d=fa(c)?{callback:c}:c||{};d._c&&d._c.jsl&&d._c.jsl.h||mb(d,{_c:{jsl:{h:H("GAPI_HINT_PARAMS",void 0)}}});if(d.gapiHintOverride||H("GAPI_HINT_OVERRIDE")){var e;var f=document.location.href;if(-1!=f.indexOf("?")){var f=(f||"").split("#")[0],h=f.split("?",2);e=Od(1<h.length?h[1]:h[0])}else e={};var k=e.gapi_jsh;k&&mb(d,{_c:{jsl:{h:k}}})}gl("client",d)}catch(m){ic(m)}})).then(function(){})}
...
ll(this,a,b,function(a){if(!e)if(e=!0,d&&J(d),a)c.P&&c.P(a);else if(c.onError)c.onError()})};
...
ql.prototype.g=function(a,b,c){b={headers:{"Content-Type":"application/json","X-Goog-Visitor-Id":H("VISITOR_DATA")},O:b,Ic:"JSON",ka:c.ka,P:c.P,onError:c.onError,timeout:c.timeout,withCredentials:!0};a:{c=[];var d=ml(String(l.location.href)),e=l.__OVERRIDE_SID;null==e&&(e=(new Pf(document)).get("SID"));if(e&&(d=(e=0==d.indexOf("https:")||0==d.indexOf("chrome-extension:"))?l.__SAPISID:l.__APISID,null==d&&(d=(new Pf(document)).get(e?"SAPISID":"APISID")),d)){var e=e?"SAPISIDHASH":"APISIDHASH",f=String(l.location.href);
c=f&&d&&e?[e,ol(ml(f),d,c||null)].join(" "):null;break a}c=null}c&&(b.headers.Authorization=c,b.headers["X-Goog-AuthUser"]=H("SESSION_INDEX",0));a="//"+this.b.Ee+("/youtubei/"+this.b.innertubeApiVersion+"/"+a)+"?alt=json&key="+this.b.innertubeApiKey;b.method="POST";b.O||(b.O={});Wd(a,b)};function Kf(){return Xe("enable_youtubei_innertube")?ql:il}
...
;var cm={Qe:"atp",$e:"ska",Xe:"que",Ve:"mus",Ze:"sus"};function dm(a){this.i=this.g="";this.b="/api/lounge";this.f=!0;a=a||document.location.href;var b=Number(Fd(4,a))||null||"";b&&(this.i=":"+b);this.g=Ed(Fd(3,a))||"";a=nb;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Ea(a,"10.0")&&(this.f=!1))}
function em(a,b,c,d){var e=a.b;if(p(d)?d:a.f)e="https://"+a.g+a.i+a.b;return Nd(e+b,c||{})}
function fm(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,P:ma(a.o,d,!0),onError:ma(a.j,e),ka:ma(a.l,e)};c&&(a.O=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return Wd(b,a)}
...
V.prototype.B=function(a,b){return this.D()?!1:this.o.B.apply(this.o,arguments)};function km(a){V.call(this);this.A=a;this.b=[]}
z(km,V);g=km.prototype;g.ea=function(){return this.b};
g.contains=function(a){return!!im(this.b,a)};
g.get=function(a){return a?jm(this.b,a):null};
g.start=u;g.mb=u;g.remove=u;g.kb=u;function lm(a,b){var c=a.get(b.uuid)||a.get(b.id);if(c)return a=c.name,c.id=b.id||c.id,c.name=b.name,c.token=b.token,c.uuid=b.uuid||c.uuid,c.name!=a;a.b.push(b);return!0}
function mm(a,b){var c=a.b.length!=b.length;a.b=Ia(a.b,function(a){return!!im(b,a)});
for(var d=0,e=b.length;d<e;d++)c=lm(a,b[d])||c;return c}
function nm(a,b){var c=a.b.length;a.b=Ia(a.b,function(a){return!(a||b?!a!=!b?0:a.id==b.id:1)});
return a.b.length<c}
g.info=function(a){Tl(this.A,a)};function om(a,b,c,d){V.call(this);this.A=a;this.l=b;this.i=c;this.j=d;this.g=0;this.b=null;this.f=NaN}
...
g.Hc=function(){this.f=NaN;this.b=Wd(em(this.A,"/pairing/get_screen"),{method:"POST",O:{pairing_code:this.l},timeout:5E3,P:x(this.He,this),onError:x(this.Ge,this),ka:x(this.Ie,this)})};
g.He=function(a,b){this.b=null;a=b.screen||{};a.dialId=this.i;a.name=this.j;this.B("pairingComplete",new Wl(a))};
g.Ge=function(a){this.b=null;a.status&&404==a.status?this.g>=pm.length?this.B("pairingFailed",Error("DIAL polling timed out")):(a=pm[this.g],this.f=I(x(this.Hc,this),a),this.g++):this.B("pairingFailed",Error("Server error "+a.status))};
g.Ie=function(){this.b=null;this.B("pairingFailed",Error("Server not responding"))};function qm(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";this.avatar=this.username="";this.capabilities=new Xc;this.experiments=new Xc;this.theme="u";if(a){this.id=a.id||a.name;this.name=a.name;this.app=a.app;this.type=a.type||"REMOTE_CONTROL";this.username=a.user||"";this.avatar=a.userAvatarUri||"";this.theme=a.theme||"u";var b=a.capabilities||"";this.capabilities.clear();Yc(this.capabilities,Ia(b.split(","),ma(ab,cm)));a=a.experiments||"";this.experiments.clear();Yc(this.experiments,
a.split(","))}}
...
var ym="";function Gm(a){km.call(this,"LocalScreenService");this.g=a;this.f=NaN;Hm(this);this.info("Initializing with "+bm(this.b))}
z(Gm,km);g=Gm.prototype;g.start=function(){Hm(this)&&this.B("screenChange");!pf("yt-remote-lounge-token-expiration")&&Im(this);J(this.f);this.f=I(x(this.start,this),1E4)};
g.mb=function(a,b){Hm(this);lm(this,a);Jm(this,!1);this.B("screenChange");b(a);a.token||Im(this)};
g.remove=function(a,b){var c=Hm(this);nm(this,a)&&(Jm(this,!1),c=!0);b(a);c&&this.B("screenChange")};
g.kb=function(a,b,c,d){var e=Hm(this),f=this.get(a.id);f?(f.name!=b&&(f.name=b,Jm(this,!1),e=!0),c(a)):d(Error("no such local screen."));e&&this.B("screenChange")};
g.w=function(){J(this.f);Gm.C.w.call(this)};
function Im(a){if(a.b.length){var b=Ka(a.b,function(a){return a.id}),c=em(a.g,"/pairing/get_lounge_token_batch");
fm(a.g,c,{screen_ids:b.join(",")},x(a.zd,a),x(a.yd,a))}}
g.zd=function(a){Hm(this);var b=this.b.length;a=a&&a.screens||[];for(var c=0,d=a.length;c<d;++c){var e=a[c],f=this.get(e.screenId);f&&(f.token=e.loungeToken,--b)}Jm(this,!b);b&&Tl(this.A,"Missed "+b+" lounge tokens.")};
g.yd=function(a){Tl(this.A,"Requesting lounge tokens failed: "+a)};
function Hm(a){var b=$l(Bm()),b=Ia(b,function(a){return!a.uuid});
return mm(a,b)}
function Jm(a,b){Am(Ka(a.b,Yl));b&&Cm()}
...
function Nm(a,b){var c;a:if($a(b)!=$a(a.b))c=!1;else{c=db(b);for(var d=0,e=c.length;d<e;++d)if(!a.b[c[d]]){c=!1;break a}c=!0}c||(Lm("Updated online screens: "+L(a.b)),a.b=b,a.B("screenChange"));Pm(a)}
...
;function W(a){km.call(this,"ScreenService");this.l=a;this.f=this.g=null;this.i=[];this.j={};Rm(this)}
z(W,km);g=W.prototype;g.start=function(){this.g.start();this.f.start();this.b.length&&(this.B("screenChange"),this.f.isEmpty()||this.B("onlineScreenChange"))};
g.mb=function(a,b,c){this.g.mb(a,b,c)};
g.remove=function(a,b,c){this.g.remove(a,b,c);this.f.update()};
g.kb=function(a,b,c,d){this.g.contains(a)?this.g.kb(a,b,c,d):(a="Updating name of unknown screen: "+a.name,Tl(this.A,a),d(Error(a)))};
...
function Sm(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);c||(c=a.j[b]);var h=a.ea();if(h=(c?jm(h,c):null)||jm(h,b)){h.uuid=b;var k=Tm(a,h);Om(a.f,k,function(a){e(a?k:null)})}else c?Um(a,c,x(function(a){var f=Tm(this,new Wl({name:d,
screenId:c,loungeToken:a,dialId:b||""}));Om(this.f,f,function(a){e(a?f:null)})},a),f):e(null)}
g.Tc=function(a,b,c,d,e){this.info("getDialScreenByPairingCode "+a+" / "+b);var f=new om(this.l,a,b,c);f.subscribe("pairingComplete",x(function(a){ac(f);d(Tm(this,a))},this));
f.subscribe("pairingFailed",function(a){ac(f);e(a)});
f.start();return x(f.stop,f)};
function Vm(a,b){for(var c=0,d=a.b.length;c<d;++c)if(a.b[c].name==b)return a.b[c];return null}
g.Ke=function(a,b,c,d){Wd(em(this.l,"/pairing/get_screen"),{method:"POST",O:{pairing_code:a},timeout:5E3,P:x(function(a,d){a=new Wl(d.screen||{});if(!a.name||Vm(this,a.name)){a:{d=a.name;for(var e=2,f=b(d,e);Vm(this,f);){e++;if(20<e)break a;f=b(d,e)}d=f}a.name=d}c(Tm(this,a))},this),
...
function Um(a,b,c,d){a.info("requestLoungeToken_ for "+b);var e={O:{screen_ids:b},method:"POST",context:a,P:function(a,e){a=e&&e.screens||[];a[0]&&a[0].screenId==b?c(a[0].loungeToken):d(Error("Missing lounge token in token response"))},
onError:function(){d(Error("Request screen lounge token failed"))}};
Wd(em(a.l,"/pairing/get_lounge_token_batch"),e)}
function Wm(a){a.b=a.g.ea();var b=a.j,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.b.length;b<d;++b){var e=a.b[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+bm(a.b))}
g.Ad=function(){Wm(this);this.B("screenChange");this.f.update()};
function Rm(a){Xm(a);a.g=new Gm(a.l);a.g.subscribe("screenChange",x(a.Ad,a));Wm(a);a.i=$l(pf("yt-remote-automatic-screen-cache")||[]);Xm(a);a.info("Initializing automatic screens: "+bm(a.i));a.f=new Km(a.l,x(a.ea,a,!0));a.f.subscribe("screenChange",x(function(){this.B("onlineScreenChange")},a))}
function Tm(a,b){var c=a.get(b.id);c?(c.uuid=b.uuid,b=c):((c=jm(a.i,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.i.push(b),N("yt-remote-automatic-screen-cache",Ka(a.i,Yl)));Xm(a);a.j[b.uuid]=b.id;N("yt-remote-device-id-map",a.j,31536E3);return b}
function Xm(a){a.j=pf("yt-remote-device-id-map")||{}}
W.prototype.dispose=W.prototype.dispose;function Ym(a,b,c){V.call(this);this.U=c;this.H=a;this.b=b;this.g=null}
z(Ym,V);g=Ym.prototype;g.xb=function(a){this.g=a;this.B("sessionScreen",this.g)};
g.ba=function(a){this.D()||(a&&Zm(this,""+a),this.g=null,this.B("sessionScreen",null))};
...
g.Le=function(a){this.D()||a||(Zm(this,"Cast session died."),this.ba())};function cn(a,b){Ym.call(this,a,b,"DialSession");this.i=this.G=null;this.L="";this.j=null;this.A=t;this.l=NaN;this.T=x(this.Oe,this);this.f=t}
z(cn,Ym);g=cn.prototype;g.Bb=function(a){this.i=a;this.i.addUpdateListener(this.T)};
...
g.w=function(){this.f();this.f=t;J(this.l);this.i&&this.i.removeUpdateListener(this.T);this.i=null;cn.C.w.call(this)};
...
function en(a){var b={};b.pairingCode=a.L;if(a.j){var c=a.j.currentTime||0;b.v=a.j.videoId;b.t=c}Fm()&&(b.env_useStageMdx=1);return Ld(b)}
g.Sb=function(a){this.L=gm();if(this.j){var b=new chrome.cast.DialLaunchResponse(!0,en(this));a(b);dn(this)}else this.A=x(function(){J(this.l);this.A=t;this.l=NaN;var b=new chrome.cast.DialLaunchResponse(!0,en(this));a(b);dn(this)},this),this.l=I(x(function(){this.A()},this),100)};
...
this.f.subscribe("onlineScreenChange",x(this.Uc,this)),this.g=gn(this),chrome.cast.setCustomReceivers(this.g,t,x(function(a){this.N("Failed to set initial custom receivers: "+L(a))},this)),this.B("yt-remote-cast2-availability-change",hn(this)),b(!0))},this),x(function(a){this.N("Failed to initialize API: "+L(a));
b(!1)},this))};
...
function ln(a,b,c){ac(a.b);(a.b=b)?(c?a.B("yt-remote-cast2-receiver-resumed",b.b):a.B("yt-remote-cast2-receiver-selected",b.b),b.subscribe("sessionScreen",x(a.Cc,a,b)),b.g?a.B("yt-remote-cast2-session-change",b.g):c&&a.b.Ha(null)):a.B("yt-remote-cast2-session-change",null)}
g.Cc=function(a,b){this.b==a&&(b||ln(this,null),this.B("yt-remote-cast2-session-change",b))};
g.Xd=function(a,b){if(!this.D())if(a)switch(jn("onReceiverAction_ "+a.label+" / "+a.friendlyName+"-- "+b),b){case chrome.cast.ReceiverAction.CAST:if(this.b)if(this.b.b.label!=a.label)jn("onReceiverAction_: Stopping active receiver: "+this.b.b.friendlyName),this.b.stop();else{jn("onReceiverAction_: Casting to active receiver.");this.b.g&&this.B("yt-remote-cast2-session-change",this.b.g);break}switch(a.receiverType){case chrome.cast.ReceiverType.CUSTOM:ln(this,new fn(this.f,a));break;case chrome.cast.ReceiverType.DIAL:ln(this,
...
this.B("yt-remote-cast2-session-change",this.b.g),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.N('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);ln(this,new cn(this.f,b))}b=this.b;b.G=a;return b.G.appState==chrome.cast.DialAppState.RUNNING?new Promise(x(b.Bd,b,(b.G.extraData||{}).screenId||null)):new Promise(x(b.Sb,b))};
...
g.Yd=function(a){jn("Receiver availability updated: "+a);if(!this.D()){var b=hn(this);this.j=a==chrome.cast.ReceiverAvailability.AVAILABLE;hn(this)!=b&&this.B("yt-remote-cast2-availability-change",hn(this))}};
...
var b=hn(this);b!=a&&this.B("yt-remote-cast2-availability-change",b)}};
...
Gn.prototype.parse=function(a){return this.b(a)};function Hn(a,b){ah.call(this);this.f=a||1;this.b=b||l;this.i=x(this.Be,this);this.j=y()}
z(Hn,ah);g=Hn.prototype;g.enabled=!1;g.fa=null;g.Be=function(){if(this.enabled){var a=y()-this.j;0<a&&a<.8*this.f?this.fa=this.b.setTimeout(this.i,this.f-a):(this.fa&&(this.b.clearTimeout(this.fa),this.fa=null),ch(this,"tick"),this.enabled&&(this.fa=this.b.setTimeout(this.i,this.f),this.j=y()))}};
...
Qn=new Rn;function Tn(a,b,c,d,e){this.b=a;this.g=c;this.A=d;this.l=e||1;this.j=45E3;this.i=new Ln(this);a=this.f=new Hn;a.f=250;a.fa&&a.enabled?(a.stop(),a.start()):a.fa&&a.stop()}
g=Tn.prototype;g.Fa=null;g.la=!1;g.Va=null;g.Yb=null;g.ib=null;g.Ua=null;g.wa=null;g.za=null;g.Ja=null;g.R=null;g.lb=0;g.ma=null;g.Fb=null;g.Ga=null;g.fb=-1;g.Mc=!0;g.Ba=!1;g.Qb=0;g.zb=null;var Un={},Vn={};g=Tn.prototype;g.setTimeout=function(a){this.j=a};
...
function Xn(a,b){a.ib=y();Zn(a);a.za=a.wa.clone();Zh(a.za,"t",a.l);a.lb=0;a.R=a.b.Jb(a.b.jb()?b:null);0<a.Qb&&(a.zb=new Jn(x(a.Rc,a,a.R),a.Qb));a.i.ub(a.R,"readystatechange",a.ne);b=a.Fa?ib(a.Fa):{};a.Ja?(a.Fb="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.R.send(a.za,a.Fb,a.Ja,b)):(a.Fb="GET",a.Mc&&!hd&&(b.Connection="close"),a.R.send(a.za,a.Fb,null,b));a.b.ja(1)}
g.ne=function(a){a=a.target;var b=this.zb;b&&3==$n(a)?b.wd():this.Rc(a)};
g.Rc=function(a){try{if(a==this.R)a:{var b=$n(this.R),c=this.R.j,d=this.R.getStatus();if(K&&!qd(10)||hd&&!pd("420+")){if(4>b)break a}else if(3>b||3==b&&!ed&&!ao(this.R))break a;this.Ba||4!=b||7==c||(8==c||0>=d?this.b.ja(3):this.b.ja(2));bo(this);var e=this.R.getStatus();this.fb=e;var f=ao(this.R);(this.la=200==e)?(4==b&&co(this),this.o?(eo(this,b,f),ed&&this.la&&3==b&&(this.i.ub(this.f,"tick",this.me),this.f.start())):fo(this,f),this.la&&!this.Ba&&(4==b?this.b.wb(this):(this.la=!1,Zn(this)))):(this.Ga=
...
g.me=function(){var a=$n(this.R),b=ao(this.R);this.lb<b.length&&(bo(this),eo(this,a,b),this.la&&4!=a&&Zn(this))};
...
function co(a){bo(a);ac(a.zb);a.zb=null;a.f.stop();Nn(a.i);if(a.R){var b=a.R;a.R=null;b.abort();b.dispose()}a.ma&&(a.ma=null)}
...
function ro(a){var b=a.b.S;if(null!=b)Y(),b?(Y(),to(a.b,a,!1)):(Y(),to(a.b,a,!0));else if(a.ca=new Tn(a,0,void 0,void 0,void 0),a.ca.Fa=a.Ob,b=a.b,b=po(b,b.jb()?a.eb:null,a.Pb),Y(),!K||qd(10))Zh(b,"TYPE","xmlhttp"),Yn(a.ca,b,!1,a.eb,!1);else{Zh(b,"TYPE","html");var c=a.ca;a=!!a.eb;c.Ua=3;c.wa=ai(b.clone());io(c,a)}}
...
g.ja=function(a){this.b.ja(a)};function uo(a){ah.call(this);this.headers=new Oc;this.L=a||null;this.f=!1;this.H=this.b=null;this.$="";this.j=0;this.o="";this.i=this.U=this.l=this.T=!1;this.G=0;this.A=null;this.ra="";this.da=this.oa=!1}
z(uo,ah);var vo=/^https?$/i,wo=["POST","PUT"];g=uo.prototype;
g.send=function(a,b,c,d){if(this.b)throw Error("[goog.net.XhrIo] Object is active with another request="+this.$+"; newUri="+a);b=b?b.toUpperCase():"GET";this.$=a;this.o="";this.j=0;this.T=!1;this.f=!0;this.b=this.L?this.L.b():Qn.b();this.H=this.L?Pn(this.L):Pn(Qn);this.b.onreadystatechange=x(this.zc,this);try{this.getStatus(),this.U=!0,this.b.open(b,String(a),!0),this.U=!1}catch(f){this.getStatus();xo(this,f);return}a=c||"";var e=this.headers.clone();d&&Vc(d,function(a,b){e.set(b,a)});
...
this.ra&&(this.b.responseType=this.ra);"withCredentials"in this.b&&this.b.withCredentials!==this.oa&&(this.b.withCredentials=this.oa);try{zo(this),0<this.G&&(this.da=Ao(this.b),this.getStatus(),this.da?(this.b.timeout=this.G,this.b.ontimeout=x(this.qc,this)):this.A=In(this.qc,this.G,this)),this.getStatus(),this.l=!0,this.b.send(a),this.l=!1}catch(f){this.getStatus(),xo(this,f)}};
...
function Bo(a){a.T||(a.T=!0,ch(a,"complete"),ch(a,"error"))}
...
function Do(a){if(a.f&&"undefined"!=typeof aa)if(a.H[1]&&4==$n(a)&&2==a.getStatus())a.getStatus();else if(a.l&&4==$n(a))In(a.zc,0,a);else if(ch(a,"readystatechange"),4==$n(a)){a.getStatus();a.f=!1;try{var b=a.getStatus(),c;a:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:c=!0;break a;default:c=!1}var d;if(!(d=c)){var e;if(e=0===b){var f=Fd(1,String(a.$));if(!f&&l.self&&l.self.location)var h=l.self.location.protocol,f=h.substr(0,h.length-1);e=!vo.test(f?f.toLowerCase():"")}d=
...
function zo(a){a.b&&a.da&&(a.b.ontimeout=null);ea(a.A)&&(l.clearTimeout(a.A),a.A=null)}
...
;function Eo(a,b,c){this.l=a||null;this.b=1;this.f=[];this.i=[];this.j=new Gn(null,!0);this.A=b||null;this.S=null!=c?c:null}
function Fo(a,b){this.f=a;this.b=b;this.context=null}
g=Eo.prototype;g.ab=null;g.Z=null;g.M=null;g.Nb=null;g.rb=null;g.gc=null;g.sb=null;g.gb=0;g.Gd=0;g.V=null;g.ya=null;g.ta=null;g.Da=null;g.xa=null;g.Eb=null;g.Qa=-1;g.tc=-1;g.ia=-1;g.bb=0;g.Pa=0;g.Ca=8;var Go=new ah;function Ho(a){Ag.call(this,"statevent",a)}
...
function To(a,b){var c;b?6<a.Ca?(a.f=a.i.concat(a.f),a.i.length=0,c=a.gb-1,b=So(a)):(c=b.A,b=b.Ja):(c=a.gb++,b=So(a));var d=a.rb.clone();O(d,"SID",a.g);O(d,"RID",c);O(d,"AID",a.Qa);Mo(a,d);c=new Tn(a,0,a.g,c,a.bb+1);c.Fa=null;c.setTimeout(Math.round(1E4)+Math.round(1E4*Math.random()));a.Z=c;Wn(c,d,b)}
...
;function bp(a,b){this.H=a;this.o=b;this.g=new G;this.f=new $o(this.Fe,this);this.b=null;this.G=!1;this.j=null;this.S="";this.A=this.i=0;this.l=[]}
...
g.nc=function(){var a={v:2};this.S&&(a.gsessionid=this.S);0!=this.i&&(a.ui=""+this.i);0!=this.A&&(a.ui=""+this.A);this.j&&mb(a,this.j);return a};
g.kc=function(a,b){"S"==b[0]?this.S=b[1]:"gracefulReconnect"==b[0]?(ap(this.f),this.f.start(),Ko(this.b)):this.B("handlerMessage",new En(b[0],b[1]))};
...
function jp(a){var b={};b.index=a.index;b.listId=a.listId;b.videoId=a.videoId;b.playerState=a.b;b.volume=a.volume;b.muted=a.j;b.audioTrackId=a.audioTrackId;b.trackData=jb(a.g);b.playerTime=a.f;b.playerTimeAt=a.i;return b}
gp.prototype.clone=function(){return new gp(jp(this))};function Z(a,b,c){V.call(this);this.i=NaN;this.$=!1;this.L=this.H=this.T=this.U=NaN;this.aa=[];this.A=this.G=this.g=this.F=this.b=null;this.Xa=a;this.aa.push(M(window,"beforeunload",x(this.xd,this)));this.f=[];this.F=new gp;this.oa=b.id;this.b=kp(this,c);this.b.subscribe("handlerOpened",this.Ld,this);this.b.subscribe("handlerClosed",this.Id,this);this.b.subscribe("handlerError",this.Jd,this);this.b.subscribe("handlerMessage",this.Kd,this);fp(this.b,b.token);this.subscribe("remoteQueueChange",function(){var a=
this.F.videoId;vm()&&N("yt-remote-session-video-id",a)},this)}
z(Z,V);g=Z.prototype;g.connect=function(a,b){if(b){var c=b.listId,d=b.videoId,e=b.index;b=b.currentTime||0;5>=b&&(b=0);var f={videoId:d,currentTime:b};c&&(f.listId=c);p(e)&&(f.currentIndex=e);c&&(this.F.listId=c);this.F.videoId=d;this.F.index=e||0;this.F.state=3;c=this.F;c.f=b;c.i=y();this.A="UNSUPPORTED";lp("Connecting with setPlaylist and params: "+L(f));this.b.connect({method:"setPlaylist",params:L(f)},a,zm())}else lp("Connecting without params"),this.b.connect({},a,zm());mp(this)};
g.dispose=function(){this.D()||(this.B("beforeDispose"),np(this,3));Z.C.dispose.call(this)};
g.w=function(){op(this);pp(this);qp(this);J(this.H);this.H=NaN;J(this.L);this.L=NaN;this.g=null;Te(this.aa);this.aa.length=0;this.b.dispose();Z.C.w.call(this);this.A=this.G=this.f=this.F=this.b=null};
function lp(a){Tl("conn",a)}
g.xd=function(){this.j(2)};
function kp(a,b){return new bp(em(a.Xa,"/bc",void 0,!1),b)}
function np(a,b){a.B("proxyStateChange",b)}
...
function rp(a){pp(a);a.T=I(x(function(){sp(this,"getNowPlaying")},a),2E4)}
function pp(a){J(a.T);a.T=NaN}
...
function vp(a,b){var c=b.params.videoId;delete b.params.videoId;c==a.F.videoId&&(gb(b.params)?a.F.g=null:a.F.g=b.params,a.B("remotePlayerChange"))}
function wp(a,b){var c=b.params.videoId||b.params.video_id,d=parseInt(b.params.currentIndex,10);a.F.listId=b.params.listId||a.F.listId;b=a.F;var e=b.videoId;b.videoId=c;b.index=d;c!=e&&hp(b);a.B("remoteQueueChange")}
function xp(a,b){b.params=b.params||{};wp(a,b);yp(a,b)}
function yp(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10),d=a.F;d.f=isNaN(c)?0:c;d.i=y();b=parseInt(b.params.state,10);b=isNaN(b)?-1:b;-1==b&&-1E3==a.F.b&&(b=-1E3);a.F.b=b;1==a.F.b?rp(a):pp(a);a.B("remotePlayerChange")}
function zp(a,b){var c="true"==b.params.muted;a.F.volume=parseInt(b.params.volume,10);a.F.j=c;a.B("remotePlayerChange")}
...
Z.prototype.getProxyState=Z.prototype.Ma;Z.prototype.j=function(a){lp("Disconnecting with "+a);op(this);this.B("beforeDisconnect",a);1==a&&Em();cp(this.b,a);this.dispose()};
...
Z.prototype.sendMessage=Z.prototype.Na;function Ap(a){km.call(this,"ScreenServiceProxy");this.Y=a;this.f=[];this.f.push(this.Y.$_s("screenChange",x(this.Je,this)));this.f.push(this.Y.$_s("onlineScreenChange",x(this.Rd,this)))}
...
g.w=function(){for(var a=0,b=this.f.length;a<b;++a)this.Y.$_ubk(this.f[a]);this.f.length=0;this.Y=null;Ap.C.w.call(this)};
...
function iq(a){Sj()?(R(Cj,new xj(a.externalChannelId,a.Fd?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Ld({event:"subscribe",source:a.source}))&&ni(a)):jq(a)}
function jq(a){Rj(function(b){b.subscription_ajax&&iq(a)},null)}
function kq(a){a=gq(a);R(Hj,new zj(a.externalChannelId,a.subscriptionId,null));(a="/gen_204?"+Ld({event:"unsubscribe",source:a.source}))&&ni(a)}
...
g.w=function(){qq.C.w.call(this);delete this.b};function tq(a,b,c,d){F.call(this);this.g=b||null;this.A="*";this.i=c||null;this.b=null;this.channel=d||null;this.H=!!a;this.G=x(this.L,this);window.addEventListener("message",this.G)}
z(tq,F);tq.prototype.L=function(a){if(!("*"!=this.i&&a.origin!=this.i||this.g&&a.source!=this.g)&&w(a.data)){var b;try{b=vd(a.data)}catch(c){return}null!=b&&(this.H&&(this.b&&this.b!=b.id||this.channel&&this.channel!=b.channel)||b&&this.l(a,b))}};
tq.prototype.l=u;tq.prototype.sendMessage=function(a,b){if(b=b||this.g){this.b&&(a.id=this.b);this.channel&&(a.channel=this.channel);try{var c=L(a);b.postMessage(c,this.A)}catch(d){ic(d,"WARNING")}}};
tq.prototype.w=function(){window.removeEventListener("message",this.G);tq.C.w.call(this)};function uq(a,b,c){tq.call(this,a,b,c||H("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.o=this.f=this.j=null}
z(uq,tq);uq.prototype.l=function(a,b){switch(b.event){case "listening":"null"!=a.origin?this.i=this.A=a.origin:ic(Error("MessageEvent origin is null"),"WARNING");this.g=a.source;this.b=b.id;this.f&&(this.f(),this.f=null);break;case "command":this.j&&(this.o&&!C(this.o,b.func)||this.j(b.func,b.args))}};function vq(){var a=this.f=new uq(!!H("WIDGET_ID_ENFORCE")),b=x(this.oe,this);a.j=b;a.o=null;this.f.channel="widget";if(a=H("WIDGET_ID"))this.f.b=a;this.i=[];this.o=!1;this.j={}}
...
g.Wd=function(){var a=x(this.sd,this);this.f.f=a};
...
Aq.prototype.w=function(){Te(this.i);this.b=null;Aq.C.w.call(this)};var Bq=!1;function Cq(a){if(a=a.match(/[\d]+/g))a.length=3}
...
(function(){if(tf)return Dq(/Firefox\/([0-9.]+)/);if(K||fd||ed)return od;if(xf)return Dq(/Chrome\/([0-9.]+)/);if(yf&&!(ad()||D("iPad")||D("iPod")))return Dq(/Version\/([0-9.]+)/);if(uf||vf){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(nb);if(a)return a[1]+"."+a[2]}else if(wf)return(a=Dq(/Android\s+([0-9.]+)/))?a:Dq(/Version\/([0-9.]+)/);return""})();function Eq(){var a=ib(Fq);return new mh(function(b,c){a.P=function(a){Rd(a)?b(a):c(new Gq("Request failed, status="+a.status,"net.badstatus"))};
a.onError=function(){c(new Gq("Unknown request error","net.unknown"))};
a.ka=function(){c(new Gq("Request timed out","net.timeout"))};
Wd("//googleads.g.doubleclick.net/pagead/id",a)})}
function Gq(a,b){na.call(this,a+", errorCode="+b);this.errorCode=b}
z(Gq,na);Gq.prototype.name="PromiseAjaxError";function Hq(a){na.call(this,a.message);this.b=a instanceof uh}
z(Hq,na);Hq.prototype.name="BiscottiError";function Iq(a,b){this.f=a;this.b=b}
Iq.prototype.then=function(a,b,c){try{if(p(this.f))return a?rh(a.call(c,this.f)):rh(this.f);if(p(this.b)){if(!b)return sh(this.b);var d=b.call(c,this.b);return!p(d)&&this.b.b?sh(this.b):rh(d)}throw Error("Invalid Result_ state");}catch(e){return sh(e)}};
lh(Iq);var Fq={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Jq=null;function Kq(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))return Lq(""),Jq=new Iq(""),"";a=JSON.parse(a.substr(4)).id;Lq(a);Jq=new Iq(a);Mq(18E5,2);return a}
function Nq(a,b){b=new Hq(b);Lq("");Jq=new Iq(void 0,b);0<a&&Mq(12E4,a-1);throw b;}
function Mq(a,b){I(function(){var a=x(Nq,l,b),a=Eq().then(Kq,a);th(a,null,t,void 0)},a)}
function Lq(a){q("yt.www.ads.biscotti.lastId_",a,void 0)}
;function Oq(){}
;function Pq(){this.b=H("ALT_PREF_COOKIE_NAME","PREF");var a;if(a=Sf.get(""+this.b,void 0)){a=unescape(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Qq[d]=c.toString())}}}
ba(Pq);var Qq=r("yt.prefs.UserPrefs.prefs_")||{};q("yt.prefs.UserPrefs.prefs_",Qq,void 0);function Rq(a){if(/^f([1-9][0-9]*)$/.test(a))throw"ExpectedRegexMatch: "+a;}
function Sq(a){if(!/^\w+$/.test(a))throw"ExpectedRegexMismatch: "+a;}
function Tq(a){a=void 0!==Qq[a]?Qq[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Pq.prototype.get=function(a,b){Sq(a);Rq(a);a=void 0!==Qq[a]?Qq[a].toString():null;return null!=a?a:b?b:""};
Pq.prototype.set=function(a,b){Sq(a);Rq(a);if(null==b)throw"ExpectedNotNull";Qq[a]=b.toString()};
Pq.prototype.remove=function(a){Sq(a);Rq(a);delete Qq[a]};
Pq.prototype.clear=function(){Qq={}};function Uq(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&(c=c.data.follow_on_url)&&ni(c)}}
;function Vq(a){P.call(this,1,arguments);this.ob=a}
z(Vq,P);function Wq(a,b){P.call(this,2,arguments);this.f=a;this.b=b}
z(Wq,P);function Xq(a,b,c,d){P.call(this,1,arguments);this.b=b;this.f=c||null;this.itemId=d||null}
z(Xq,P);function Yq(a,b){P.call(this,1,arguments);this.f=a;this.b=b||null}
z(Yq,P);function Zq(a){P.call(this,1,arguments)}
z(Zq,P);var $q=new Q("ypc-core-load",Vq),ar=new Q("ypc-guide-sync-success",Wq),br=new Q("ypc-purchase-success",Xq),cr=new Q("ypc-subscription-cancel",Zq),dr=new Q("ypc-subscription-cancel-success",Yq),er=new Q("ypc-init-subscription",Zq);var fr=!1,gr=[],hr=[];function ir(a){a.b?fr?R(Gj,a):R($q,new Vq(function(){R(er,new Zq(a.b))})):jr(a.f,a.i,a.g,a.source)}
function kr(a){a.b?fr?R(Lj,a):R($q,new Vq(function(){R(cr,new Zq(a.b))})):lr(a.f,a.subscriptionId,a.i,a.g,a.source)}
function mr(a){nr(Ta(a.b))}
function or(a){pr(Ta(a.b))}
function qr(a){rr(a.g,a.f,a.b)}
function sr(a){var b=a.itemId,c=a.b.subscriptionId;b&&c&&R(Fj,new yj(b,c,a.b.channelInfo))}
function tr(a){var b=a.b;Ya(a.f,function(a,d){R(Fj,new yj(d,a,b[d]))})}
function ur(a){R(Kj,new vj(a.f.itemId));a.b&&a.b.length&&(vr(a.b,Kj),vr(a.b,Mj))}
function jr(a,b,c,d){var e=new vj(a);R(Dj,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=H("PLAYBACK_ID"))&&(c.plid=d);(d=H("EVENT_ID"))&&(c.ei=d);b&&wr(b,c);Wd("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Xb:f,O:c,P:function(b,c){b=c.response;R(Fj,new yj(a,b.id,b.channel_info));b.show_feed_privacy_dialog&&tc("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);b.actions&&Uq(b.actions)},
Ub:function(){R(Ej,e)}})}
function lr(a,b,c,d,e){var f=new vj(a);R(Ij,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=H("PLAYBACK_ID"))&&(d.plid=a);(a=H("EVENT_ID"))&&(d.ei=a);c&&wr(c,d);Wd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Xb:h,O:d,P:function(a,b){a=b.response;R(Kj,f);a.actions&&Uq(a.actions)},
Ub:function(){R(Jj,f)}})}
function rr(a,b,c){if(a){var d={};d.channel_id=a;switch(b){case "receive-all-updates":d.receive_all_updates=!0;break;case "receive-no-updates":d.receive_no_updates=!0;d.receive_post_updates=!1;break;case "receive-highlight-updates":d.receive_all_updates=!1;d.receive_no_updates=!1;break;default:return}null===c||d.receive_no_updates||(d.receive_post_updates=c);var e=new wj(a,b,c);Wd("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",O:d,onError:function(){R(Qj,e)},
P:function(){R(Pj,e)}})}}
function nr(a){if(a.length){var b=Va(a,0,40);R("subscription-batch-subscribe-loading");vr(b,Dj);var c={};c.a=b.join(",");var d=function(){R("subscription-batch-subscribe-loaded");vr(b,Ej)};
Wd("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",O:c,P:function(c,f){d();c=f.response;f=c.id;if(v(f)&&f.length==b.length){var e=c.channel_info_map;B(f,function(a,c){c=b[c];R(Fj,new yj(c,a,e[c]))});
a.length?nr(a):R("subscription-batch-subscribe-finished")}},
onError:function(){d();R("subscription-batch-subscribe-failure")}})}}
function pr(a){if(a.length){var b=Va(a,0,40);R("subscription-batch-unsubscribe-loading");vr(b,Ij);var c={};c.c=b.join(",");var d=function(){R("subscription-batch-unsubscribe-loaded");vr(b,Jj)};
Wd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",O:c,P:function(){d();vr(b,Kj);a.length&&pr(a)},
onError:function(){d()}})}}
function vr(a,b){B(a,function(a){R(b,new vj(a))})}
function wr(a,b){a=Od(a);for(var c in a)b[c]=a[c]}
;var xr=null,yr=null,zr=null,Ar=!1;function Br(a){var b=a.csn;a=a.root_ve_type;b&&a&&(fc("client-screen-nonce",b),fc("ROOT_VE_TYPE",a))}
function Cr(a){var b=Nf();b&&Lf(Kf(),{click:{csn:b,visualElement:Af(new zf(a))}},void 0)}
function Dr(a){var b=Nf();if(b){for(var c=[],d=0;d<a.length;d++)c.push(new zf(a[d]));Jf(b,c)}}
...
q("writeEmbed",function(){var a=H("PLAYER_CONFIG",void 0);if("1"!=a.privembed)try{var b;try{var c=r("yt.www.ads.biscotti.getId_"),d;if(c)d=c();else{if(!Jq){var e=x(Nq,l,2);Jq=Eq().then(Kq,e)}d=Jq}b=d}catch(f){b=sh(f)}th(b,null,Oq,void 0)}catch(f){ic(f)}"gvn-experiment"==a.args.ps&&(document.body.style.backgroundColor="transparent");d=document.referrer;b=H("POST_MESSAGE_ORIGIN");c=!1;Xe("legacy_cast2")&&w(d)&&w(b)&&-1<d.indexOf(b)&&ki(b)&&ki(d)&&(c=!0);window!=window.top&&d&&d!=document.URL&&(a.args.loaderUrl=
d);H("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&vl(a.args);xr=d=ij("player",a);d.addEventListener("onScreenChanged",Br);d.addEventListener("onLogServerVeClicked",Cr);d.addEventListener("onLogServerVesShown",Dr);e=H("POST_MESSAGE_ID","player");H("ENABLE_JS_API")?zr=new yq(d):H("ENABLE_POST_API")&&w(e)&&w(b)&&(yr=new Aq(window.parent,e,b),zr=new qq(d,yr.f));Xe("legacy_cast2")&&((Ar=c&&!H("ENABLE_CAST_API"))?a.args.disableCast="1":(Bp(),aq=d,aq.addEventListener("onReady",cq),bq.push(qc("yt-remote-receiver-availability-change",
dq))));H("BG_P")&&(H("BG_I")||H("BG_IU"))&&Gc();ge();eq=d;eq.addEventListener("SUBSCRIBE",hq);eq.addEventListener("UNSUBSCRIBE",kq);fq.push(vi(Fj,lq),vi(Kj,mq))},void 0);
q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a+="mac_204?action_fcts=1")&&ni(a);return!0},void 0);
var Er=hc(function(){Fi("ol");fr=!0;hr.push(vi(Cj,ir),vi(Hj,kr));fr||hr.push(vi(Gj,ir),vi(Lj,kr),vi(Aj,mr),vi(Bj,or),vi(Oj,qr),vi(br,sr),vi(dr,ur),vi(ar,tr));var a=Pq.getInstance(),b=1<window.devicePixelRatio;if(!!((Tq("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=Tq(c)||0,d=b?d|67108864:d&-67108865;0==d?delete Qq[c]:(b=d.toString(16),Qq[c]=b.toString());var a=a.b,c=[],e;for(e in Qq)c.push(e+"="+escape(Qq[e]));Tf(a,c.join("&"),63072E3)}}),Fr=hc(function(){var a=
xr;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();H("PL_ATT")&&(Fc=null);for(var a=0,b=ee.length;a<b;a++){var c=ee[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):J(c)}}ee.length=0;a=Bc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))wc(a),b.parentNode.removeChild(b);fe=!1;fc("DCLKSTAT",0);sc(gr);gr.length=0;wi(hr);hr.length=0;fr=!1;eq&&(eq.removeEventListener("SUBSCRIBE",iq),eq.removeEventListener("UNSUBSCRIBE",kq));eq=null;wi(fq);fq.length=0;
Xe("legacy_cast2")&&!Ar&&(sc(bq),bq.length=0,aq&&(aq.removeEventListener("onReady",cq),aq=null),Pp());bc(zr,yr);if(a=xr)a.removeEventListener("onScreenChanged",Br),a.removeEventListener("onLogServerVeClicked",Cr),a.removeEventListener("onLogServerVesShown",Dr),a.destroy()});
window.addEventListener?(window.addEventListener("load",Er),window.addEventListener("unload",Fr)):window.attachEvent&&(window.attachEvent("onload",Er),window.attachEvent("onunload",Fr));var Gr=ok.getInstance(),Hr=S(Gr);Hr in tk||(Gr.register(),Gr.yb.push(qc("yt-uix-init-"+Hr,Gr.init,Gr)),Gr.yb.push(qc("yt-uix-dispose-"+Hr,Gr.dispose,Gr)),tk[Hr]=Gr);})();
